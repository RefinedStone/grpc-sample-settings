...
class TestEntity(
    ...
    companion object {
        ...
        fun protoToKotlin(testEntityProto: Protobuff.TestEntity): TestEntity {
            ...
            val members =
                testEntityProto.membersList.map {
                    TestEntity.Member(
                        name = it.name,
            ...
            val products =
                testEntityProto.productsList.map {
                    TestEntity.Product(
